        ...
        <div class="container">
            <div class="row g-4 align-items-center">
                <div class="col-lg-10 col-xl-7">
                    ...
                    <h1 class="text-white mt-1" data-sal="fade" data-sal-duration="500" data-sal-delay="200" data-sal-easing="ease-in-out-sine">Fast
                        ...
                        <span class="d-none d-md-inline-block position-relative z-1">
                            <img src="{{asset('App/assets//img/hero-title.png')}}" alt="image" class="img-fluid">
                ...
                <div class="col-xl-5">
                    <div class="position-relative z-1">
                        ...
                        <div class="hero-1__map">
                            <img class="img-fluid hero-1__map-img" src="{{asset('App/assets//img/shape/hero-map.png')}}" alt="image">
                                    ...
                                    <div class="hero-1__map-location-info">
                                        <div class="hero-1__map-location-info-btn">
                                            <div class="hero-1__map-location-info-btn-img">
                                                <img src="{{asset('App/assets//img/flag-5.png')}}" alt="image" class="img-fluid">
                                            </div>
                                        ...
                                        <div class="hero-1__map-location-info-arrow">
                                            <img src="{{asset('App/assets//img/shape/location-arrow.png')}}" alt="image" class="img-fluid">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="hero-1__map-location hero-1__map-location--3">
                                <div class="hero-1__map-location-dot">
                                    <div class="hero-1__map-location-info">
                                        <div class="hero-1__map-location-info-btn">
                                            <div class="hero-1__map-location-info-btn-img">
                                                <img src="{{asset('App/assets//img/flag-7.png')}}" alt="image" class="img-fluid">
                                            </div>
                                            <div class="hero-1__map-location-info-btn-text">
                                                Russia
                                            </div>
                            ...
                            <div class="hero-1__map-location hero-1__map-location--4">
                                <div class="hero-1__map-location-dot">
                                    <div class="hero-1__map-location-info">
                                        <div class="hero-1__map-location-info-btn">
                                            <div class="hero-1__map-location-info-btn-img">
                                                <img src="{{asset('App/assets//img/flag-8.png')}}" alt="image" class="img-fluid">
                                            </div>
                                            <div class="hero-1__map-location-info-btn-text">
                                                New York
                                            </div>
                            ...
                            <div class="hero-1__map-location hero-1__map-location--5">
                                <div class="hero-1__map-location-dot">
                                    <div class="hero-1__map-location-info">
                                        <div class="hero-1__map-location-info-btn">
                                            <div class="hero-1__map-location-info-btn-img">
                                                <img src="{{asset('App/assets//img/flag-9.png')}}" alt="image" class="img-fluid">
                                            </div>
                                            <div class="hero-1__map-location-info-btn-text">
                                                Brazil
                                            </div>
                            ...
                            <div class="hero-1__map-location hero-1__map-location--6">
                                <div class="hero-1__map-location-dot">
                                    <div class="hero-1__map-location-info">
                                        <div class="hero-1__map-location-info-btn">
                                            <div class="hero-1__map-location-info-btn-img">
                                                <img src="{{asset('App/assets//img/flag-10.png')}}" alt="image" class="img-fluid">
                                            </div>
                                            <div class="hero-1__map-location-info-btn-text">
                                                Hongkong
                                            </div>
                            ...
                            <div class="hero-1__map-location hero-1__map-location--7">
                                <div class="hero-1__map-location-dot">
                                    <div class="hero-1__map-location-info">
                                        <div class="hero-1__map-location-info-btn">
                                            <div class="hero-1__map-location-info-btn-img">
                                                <img src="{{asset('App/assets//img/flag-11.png')}}" alt="image" class="img-fluid">
                                            </div>
                                            <div class="hero-1__map-location-info-btn-text">
                                                Bangladesh
                                            </div>
                            ...
                            <div class="hero-1__map-location hero-1__map-location--8">
                                <div class="hero-1__map-location-dot">
                                    <div class="hero-1__map-location-info">
                                        <div class="hero-1__map-location-info-btn">
                                            <div class="hero-1__map-location-info-btn-img">
                                                <img src="{{asset('App/assets//img/flag-12.png')}}" alt="image" class="img-fluid">
                                            </div>
                                            <div class="hero-1__map-location-info-btn-text">
                                                India
                                            </div>
                ...
                <div class="col-xl-10">
                    <div class="card rounded-4">
                        <div class="card-body pt-60 pb-60">
                            <div class="row justify-content-center">
                                <div class="col-lg-8">
                                    <h2 class="text-center h4" data-sal="slide-up" data-sal-duration="500" data-sal-delay="200" data-sal-easing="ease-in-out-sine">
                                        Find the Right Plan & Register a Domain Now!</h2>
                                    <form action="#" class="domain-form-one mx-auto position-relative mt-8" data-sal="slide-up" data-sal-duration="500" data-sal-delay="200" data-sal-easing="ease-in-out-sine">
                                        <input type="text" class="form-control bg-transparent p-4" placeholder="Domain Name">
                ...
                <div class="col-12">
                    ...
                    <div class="d-flex justify-content-center align-items-center gap-6 flex-wrap flex-lg-nowrap">
                        <a href="#" class="d-inline-block" data-sal="slide-up" data-sal-duration="500" data-sal-delay="300" data-sal-easing="ease-in-out-sine">
                            <img src="{{asset('App/assets//img/brand-1.png')}}" alt="image" class="img-fluid transition opacity-50 brand-img">
                        </a>
                        <a href="#" class="d-inline-block" data-sal="slide-up" data-sal-duration="500" data-sal-delay="400" data-sal-easing="ease-in-out-sine">
                            <img src="{{asset('App/assets//img/brand-3.png')}}" alt="image" class="img-fluid transition opacity-50 brand-img">
                        </a>
                        <a href="#" class="d-inline-block" data-sal="slide-up" data-sal-duration="500" data-sal-delay="500" data-sal-easing="ease-in-out-sine">
                            <img src="{{asset('App/assets//img/brand-2.png')}}" alt="image" class="img-fluid transition opacity-50 brand-img">
                        </a>
                        <a href="#" class="d-inline-block" data-sal="slide-up" data-sal-duration="500" data-sal-delay="600" data-sal-easing="ease-in-out-sine">
                            <img src="{{asset('App/assets//img/brand-3.png')}}" alt="image" class="img-fluid transition opacity-50 brand-img">
                        </a>
                        <a href="#" class="d-inline-block" data-sal="slide-up" data-sal-duration="500" data-sal-delay="700" data-sal-easing="ease-in-out-sine">
                            <img src="{{asset('App/assets//img/brand-4.png')}}" alt="image" class="img-fluid transition opacity-50 brand-img">
                        </a>
                        <a href="#" class="d-inline-block" data-sal="slide-up" data-sal-duration="500" data-sal-delay="800" data-sal-easing="ease-in-out-sine">
                            <img src="{{asset('App/assets//img/brand-2.png')}}" alt="image" class="img-fluid transition opacity-50 brand-img">
                        </a>
                    </div>
                </div>
    ...
    <section class="why-area-one bg-dark pt-120 pb-120 position-relative z-1">
        <div class="container">
            <div class="row align-items-center justify-content-between">
                <div class="col-xl-7">
                    <h2 class="text-white" data-sal="slide-up" data-sal-duration="500" data-sal-delay="200" data-sal-easing="ease-in-out-sine">Why Choose Hostcity Hosting for Your Hosting Needs?</h2>
                </div>
                <div class="col-xl-4">
                    <p class="text-white" data-sal="slide-up" data-sal-duration="500" data-sal-delay="300" data-sal-easing="ease-in-out-sine">SSL is industry-standard encryption! Protect important data, win visitors Pick a
                ...
                <div class="row g-4">
                    <div class="col-xl-3 col-md-6" data-sal="slide-up" data-sal-duration="500" data-sal-delay="200" data-sal-easing="ease-in-out-sine">
                        <div class="why-card px-6 py-9 rounded-3 transition">
                            <img src="{{asset('App/assets//img/why-icon-1.png')}}" alt="image" class="img-fluid">
                            <img src="{{asset('App/assets//img/why-icon-1-dark.png')}}" alt="image" class="img-fluid dark">
                    ...
                    <div class="col-xl-3 col-md-6" data-sal="slide-up" data-sal-duration="500" data-sal-delay="300" data-sal-easing="ease-in-out-sine">
                        <div class="why-card px-6 py-9 rounded-3 transition">
                            <img src="{{asset('App/assets//img/why-icon-2.png')}}" alt="image" class="img-fluid">
                            <img src="{{asset('App/assets//img/why-icon-2-dark.png')}}" alt="image" class="img-fluid dark">
                    ...
                    <div class="col-xl-3 col-md-6" data-sal="slide-up" data-sal-duration="500" data-sal-delay="400" data-sal-easing="ease-in-out-sine">
                        <div class="why-card px-6 py-9 rounded-3 transition">
                            <img src="{{asset('App/assets//img/why-icon-3.png')}}" alt="image" class="img-fluid">
                            <img src="{{asset('App/assets//img/why-icon-3-dark.png')}}" alt="image" class="img-fluid dark">
                    ...
                    <div class="col-xl-3 col-md-6" data-sal="slide-up" data-sal-duration="500" data-sal-delay="500" data-sal-easing="ease-in-out-sine">
                        <div class="why-card px-6 py-9 rounded-3 transition">
                            <img src="{{asset('App/assets//img/why-icon-4.png')}}" alt="image" class="img-fluid">
                            <img src="{{asset('App/assets//img/why-icon-4-dark.png')}}" alt="image" class="img-fluid dark">
        ...
        <div class="pb-40">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-xl-8">
                        <div class="text-center">
                            <h2 class="text-white mb-0" data-sal="slide-up" data-sal-duration="500" data-sal-delay="200" data-sal-easing="ease-in-out-sine">Hostcity Hosting is the Industry’s Best Hosting Solution
                            </h2>
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-10 col-xl-8">
                    <div class="bg-white p-3 shadow-lg rounded position-relative" data-sal="slide-up" data-sal-duration="500" data-sal-delay="200" data-sal-easing="ease-in-out-sine">
                        <img src="{{asset('App/assets//img/video-bg.png')}}" alt="" class="img-fluid w-100">
    ...
    <section class="pt-60 pb-60">
        <div class="container">
            <div class="row align-items-center g-6">
                <div class="col-lg-6">
                    <img src="{{asset('App/assets//img/wp-hosting.png')}}" alt="image" class="img-fluid" data-sal="slide-up" data-sal-duration="500" data-sal-delay="200" data-sal-easing="ease-in-out-sine">
                </div>
                <div class="col-lg-6" data-sal="slide-up" data-sal-duration="500" data-sal-delay="300" data-sal-easing="ease-in-out-sine">
                    ...
                    <div class="d-flex align-items-center gap-5 flex-wrap mt-10">
                        <a href="wp-hosting.html" class="btn btn-primary btn-arrow btn-arrow btn-arrow-md btn-lg fs-14 fw-medium rounded">
                            <span class="btn-arrow__text">
                                Get Started
                                <span class="btn-arrow__icon">
                                    <i class="las la-arrow-right"></i>
            ...
            <div class="row">
                <div class="col-xl-7" data-sal="fade" data-sal-duration="500" data-sal-delay="200" data-sal-easing="ease-in-out-sine">
                    <div class="single-blog-post">
                        <img src="{{asset('App/assets//img/blog-1.png')}}" alt="image" class="img-fluid w-100">
                        <div class="blog-post-content px-6 px-md-8 py-9">
                            ...
                            <h5 class="mb-6">
                                <a href="blog-details.html" class="text-decoration-none text-white hover:text-primary transition">
                                    WordPress 6.4 Release Updates Unleashing
                                    The Potential for Innovation
                                </a>
                            </h5>
                            <a href="blog-details.html" class="text-decoration-none d-inline-flex align-items-center gap-2 text-primary fw-semibold btn-arrow">
                            ...
                            <div class="side-blog-item px-6 py-7 d-flex align-items-center justify-content-between gap-5 rounded-3 transition">
                                <div>
                                    ...
                                    <h6 class="text-white mb-4">
                                        <a href="blog-details.html" class="d-inline-block text-decoration-none text-white hover:text-primary transition max-text-28">
                                ...
                                <a href="blog-details.html" class="arrow-btn d-grid place-content-center w-8 h-8 rounded-circle border border-secondary flex-shrink-0 transition opacity-25">
                ...
                <div class="row justify-content-center">
                    <div class="col-xxl-7 col-xl-9">
                        ...
                        <div class="text-center mt-5">
                            <h2 class="mb-5" data-sal="slide-up" data-sal-duration="500" data-sal-delay="200" data-sal-easing="ease-in-out-sine">Migrate your Website for Free</h2>
                            <p class="mb-8" data-sal="slide-up" data-sal-duration="500" data-sal-delay="200" data-sal-easing="ease-in-out-sine">We’ll take care of the process of moving your website
                        ...
                        <div class="d-flex align-items-center justify-content-center gap-4 flex-wrap flex-md-nowrap" data-sal="slide-up" data-sal-duration="500" data-sal-delay="200" data-sal-easing="ease-in-out-sine">
                            ...
                            <a href="contact.html" class="btn btn-dark btn-arrow btn-arrow-md btn-lg fs-14 fw-medium rounded">
                                <span class="btn-arrow__text">
                                    Learn More
                                    <span class="btn-arrow__icon">
                                        <i class="las la-arrow-right"></i>
